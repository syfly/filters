...
public abstract class MediaEncoder implements Runnable {
	...
	Log.v(TAG, "frameAvailableSoon mIsCapturing=" + mIsCapturing + "  mRequestStop=" + mRequestStop);
        synchronized (mSync) {
...
//		android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
    ...
    */
	/*package*/ void stopRecording() {
		if (DEBUG) Log.v(TAG, "stopRecording mRequestStop=" + mRequestStop + " mIsCapturing=" + mIsCapturing);
		synchronized (mSync) {
			if (!mIsCapturing || mRequestStop) {
				return;
			}
			...
			Log.v(TAG, " stopRecording mRequestStop ");
